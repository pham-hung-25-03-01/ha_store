...
public class SPKhuyenMaiAdapter extends RecyclerView.Adapter<SPKhuyenMaiAdapter.ViewHolder> {
    List<SanPhamDTO> ds_sp_khuyen_mai;
    List<AnhSanPhamDTO> list_anh;
    SanPhamDAO sp_dao;
    public SPKhuyenMaiAdapter(List<SanPhamDTO> ds_sp_khuyen_mai) {
        this.ds_sp_khuyen_mai = ds_sp_khuyen_mai;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SanPhamDTO sp = ds_sp_khuyen_mai.get(position);
    ...
    public int getItemCount() {
        if(ds_sp_khuyen_mai!= null) {
            return ds_sp_khuyen_mai.size();
        }
        return 0;
    }
